...
export default function Index({ auth }) {
    ...
    async function getListBank(page = 1, length = 10, namaPaket, role) {
        ...
        try {
            const response = await axios.get("/admin/list-brand-request", {
                params: parameter,
            });
    ...
    async function postPaket(page = 1, length = 10) {
        ...
        parameter.append("brand_name", formData.brand_name);
    ...
    async function hapusPaket(id, page = 1, length = 10) {
        ...
        try {
            const response = await axios.post("/admin/delete-brand", parameter);
            if (response.data.code !== 0) {
                console.log("error");
                throw new Error(response.data.msg);
            }
