...
export default function Index({ auth }) {
    ...
    async function getListBank(page = 1, length = 10, namaPaket, role) {
        ...
        try {
            const response = await axios.get("/admin/list-category-request", {
                params: parameter,
            });
    ...
    async function postPaket(page = 1, length = 10) {
        ...
        parameter.append("category_name", formData.category_name);
                                                    ...
                                                    <Dropdown className="absolute">
                                                        ...
                                                        <Dropdown.Content>
                                                            <div className="relative z-50">
                                                                ...
                                                                {e.document && (
                                                                    <a
                                                                        href={`download-file-category/${e.id}`}
