...
export default function Index({ auth }) {
    ...
    async function getListBank(page = 1, length = 10, namaPaket, role) {
        ...
        try {
            const response = await axios.get("/admin/list-sales-request", {
                params: parameter,
            });
    ...
    async function postPaket(page = 1, length = 10) {
        ...
        parameter.append("nama", formData.nama);
        parameter.append("no_hp", formData.no_hp);
        parameter.append("is_enabled", formData.is_enabled);
        parameter.append("alamat", formData.alamat);
        parameter.append("document", formData.document); // file object
    ...
    async function hapusPaket(id, page = 1, length = 10) {
        ...
        try {
            const response = await axios.post("/admin/delete-sales", parameter);
            if (response.data.code !== 0) {
                console.log("error");
                throw new Error(response.data.msg);
            }
                                    ...
                                    <DialogBody className="grid gap-4 text-white">
                                        ...
                                        >
                                            ...
                                            <Textarea
                                                ...
                                                onChange={handleChange}
                                                required
                                                className="text-white placeholder-gray-400 !border-gray-600 focus:!border-white"
                                                labelProps={{
                                                    className: "text-white",
                                                }}
                                                color="white"
