...
export default function reportPembayaran({ auth, bank }) {
    // console.log(bank);
    const now = new Date();
    ...
    async function search() {
        ...
        settotal_bayar(response.total_bayar);
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [jatuh_tempo, idBank, startDate, endDate]);
    ...
    async function getReportTamu(user_id, jatuh_tempo) {
        ...
        try {
            ...
            const response = await axios.get(
                "/admin/report-pembayaran-request",
                {
                    params: parameter,
                }
            );
                            ...
                            <div className="my-2 grid grid-flow-col auto-cols-max gap-2">
                                <div className="md:w-56 w-full max-w-sm">
                                    ...
                                    >
                                        ...
                                        <option value={0}>Telat Bayar</option>
                                    ...
                                    <>
                                        {data.map((dt, index) => (
                                            <tr key={index}>
                                                ...
                                                <td className="border border-black px-3">
                                                    {rupiah(
                                                        dt.invoice.grand_total
                                                    )}
                                                </td>
                                                <td className="border border-black px-3">
                                                    {formatTanggal(
                                                        dt.invoice.jatuh_tempo
                                                    )}
                                                </td>
